// backend/routes/register.js (or .mjs if you're not using "type": "module")

import express from 'express';
import { calculateFruit } from './Calc/Calculate.js';
...
export function register(app) {
  ...
  app.get('/api/CalculatePrice', (req, res) => {
    ...
    try {
      ...
      const result = calculateFruit.calculateFruit(tool);
